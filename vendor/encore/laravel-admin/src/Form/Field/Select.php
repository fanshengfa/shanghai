...
class Select extends Field
{
    ...
    {
        $placeholder = $this->placeholder or $this->label;
        if (empty($this->script)) {
            if($this->placeholder) {
                $this->script = <<<EOF
$("{$this->getElementClassSelector()}").prepend('<option></option>');
if($("{$this->getElementClassSelector()}").find("option:selected").length==0) {
